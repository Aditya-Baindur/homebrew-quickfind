class Quickfind < Formula
  ...
  sha256 "34052e7bab22fd994268090324cd6eb837d657daad1d50fb402925b59cb175e6"  # Use the actual checksum of the raw script

  depends_on "zsh"  # If required, to run the script

  def install
    bin.install "cmd.sh"  # This installs the script to the bin directory
  end
end
